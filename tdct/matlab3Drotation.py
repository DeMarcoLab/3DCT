...
def genMatlabScript():
    ...
    format_args = [
        ...
        endiantype,
        # {3} = 'int'  vol in dimension x    e.g. 1344    [px]
        dimensions_x,
        # {4} = 'int'  vol in dimension y    e.g. 1024    [px]
        dimensions_y,
        # {5} = 'int'  vol in dimension z    e.g. 106    [px]
        dimensions_z,
        # {6} = 'str'  fileout e.g. /path/to/dir/filename without extension
        fileout,
        # {7} = 'int'  correlated rotation angle e.g. FIB: phi
        eul1_phi,
        # {8} = 'int'  correlated rotation angle e.g. FIB: psi
        eul1_psi,
        ...
        eul2_psi,
        # {15} = 'int'  second correlated rotation angle e.g. SEM: theta
        eul2_theta,
        ...
        lam_start_x + 1,
        # {20} = 'int'  lamella end x coordinate        (2)         |                    |
        lam_end_x + 1,
        # {21} = 'int'  lamella start y coordinate    (3)         |                    |
        lam_start_y + 1,
